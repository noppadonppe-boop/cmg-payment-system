...
const NAV_ITEMS = [
  {
    ...
    path: '/dashboard',
    roles: ['MasterAdmin', 'SuperAdmin', 'Admin', 'MD', 'GM', 'CD', 'PM', 'CM', 'QsEng', 'AccCMG'],
  },
  {
    label: 'Projects',
    icon: FolderOpen,
  ...
  },
  {
    ...
    icon: Shield,
    path: '/bonds',
    roles: ['MasterAdmin', 'SuperAdmin', 'Admin', 'MD', 'GM', 'CD', 'PM', 'CM', 'AccCMG'],
  },
  {
    label: 'Payments',
    icon: CreditCard,
  ...
  },
  {
    ...
    icon: Users,
    path: '/admin',
    roles: ['MasterAdmin', 'SuperAdmin', 'Admin'],
  },
  {
    label: 'User Manual',
    icon: BookOpen,
